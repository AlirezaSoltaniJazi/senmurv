...
| Page geometry / colours read by **Tools → Measure / Colour** | Read transiently on the active tab while you hover or click, to compute sizes, box models and colours. The eyedropper samples a screen pixel only when you invoke it. Nothing is stored or transmitted.                                                                                                                           | No               |
